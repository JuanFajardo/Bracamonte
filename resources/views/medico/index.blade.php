    ...
    <div class="modal-content panel panel-primary">
      ...
      <div class="modal-body panel-body">
        ...
        <div class="form-group">
          ...
          {!! Form::text('medico', null, ['class'=>'form-control', 'placeholder'=>'Medico', 'id'=>'medico_', 'required']) !!}
        </div>
        <div class="form-group">
    ...
    <div id="modalModifiar" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content panel panel-warning">
                ...
                <div class="modal-body panel-body">
                    {!! Form::open(['route'=>['Medico.update', ':DATO_ID'], 'method'=>'PATCH', 'id'=>'form-update' ])!!}
...
{!! Form::open(['route'=>['Medico.destroy', ':DATO_ID'], 'method'=>'DELETE', 'id'=>'form-delete']) !!}
{!! Form::close() !!}
@endsection
